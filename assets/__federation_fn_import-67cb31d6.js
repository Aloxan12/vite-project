...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react-85510186.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom-e806fc46.js', import.meta.url).href),import:true},'mobx':{get:()=>()=>__federation_import(new URL('__federation_shared_mobx-3b3e172d.js', import.meta.url).href),import:true},'axios':{get:()=>()=>__federation_import(new URL('__federation_shared_axios-fed4e6e4.js', import.meta.url).href),import:true},'mobx-react':{get:()=>()=>__federation_import(new URL('__federation_shared_mobx-react-7fa5df69.js', import.meta.url).href),import:true}};
